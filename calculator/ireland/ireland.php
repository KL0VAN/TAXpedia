...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo irlandese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Ireland)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Ireland)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Ireland allocation chart",
    ...
    'box_eu_desc' => "Allocation of Ireland's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorIreland.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <ul>
        <li>Expenditure Report 2026 (Part II e Part III)</li>
        <li><a href="https://www.whereyourmoneygoes.gov.ie/en/2026/" style="text-decoration: underline;">where your money goes</a></li>
      </ul>
      </section>
    </div>
  </main>

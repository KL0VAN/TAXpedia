...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Lussemburgo)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Lussemburgo)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Lussemburgo",
    ...
    'box_eu_desc' => "Distribuzione del contributo lussemburghese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Luxembourg)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Luxembourg)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Luxembourg allocation chart",
    ...
    'box_eu_desc' => "Allocation of Luxembourg’s contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorLuxembourg.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=LU"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>

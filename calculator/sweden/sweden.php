...
$ITLP_I18N = array(
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Sweden)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Sweden)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Sweden allocation chart",
    ...
    'box_eu_desc' => "Allocation of Sweden's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorSweden.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=SE"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        ...
        <li>Budgetpropositionen för 2025 (Prop. 2024/25:1)</li>
        <li>Statens budget för 2025</li>
        <li>Räkenskapssammandrag för kommuner och regioner (SCB)</li>
        <li>Kommunalskatterna 2026 (SCB)</li>
      </ul>
      </section>
    </div>
  </main>

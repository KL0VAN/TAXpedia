/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 61435, rate: 0.3238 },
  { upper: Infinity, rate: 0.5238 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',          percentuale:0.3209, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',        percentuale:0.1302, link:'' },
  { id: 'def',  nome:'Difesa',                      percentuale:0.1177, link:'' },
  { id: 'san',  nome:'Sanità',                      percentuale:0.0863, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',  percentuale:0.0750, link:'' },
  { id: 'eco',  nome:'Politiche economiche',        percentuale:0.0467, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',    percentuale:0.0410, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico', percentuale:0.0339, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                 percentuale:0.0331, link:'' },
  { id: 'giu',  nome:'Giustizia',                   percentuale:0.0266, link:'' },
  { id: 'int',  nome:'Interessi',                   percentuale:0.0199, link:'' },
  { id: 'cul',  nome:'Cultura e sport',             percentuale:0.0164, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',       percentuale:0.0114, link:'' },
  { id: 'alt',  nome:'Altro',                       percentuale:0.0407, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.01302, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00935, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00349, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00274, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00221, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00091, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00074, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00064, link:'/article/europe/sicurezza_difesa.php' },
];

...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Ungheria)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Ungheria)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Ungheria",
    ...
    'box_eu_desc' => "Distribuzione del contributo ungherese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Hungary)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Hungary)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Hungary allocation chart",
    ...
    'box_eu_desc' => "Allocation of Hungary's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorHungary.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=HU"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Nemzetgazdasági Minisztérium</li>
        <li>2025. évi LXIX. törvény Magyarország 2026. évi központi költségvetéséről</li>
        <li>Nemzeti Adó- és Vámhivatal</li>
        <li>Központi Statisztikai Hivatal</li>
      </ul>
      </section>
    </div>
  </main>

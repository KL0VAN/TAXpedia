/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: Infinity, rate: 0.335 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',          percentuale:0.3011, link:'' },
  { id: 'san',  nome:'Sanità',                      percentuale:0.1630, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',        percentuale:0.0961, link:'' },
  { id: 'int',  nome:'Interessi',                   percentuale:0.0768, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',  percentuale:0.0697, link:'' },
  { id: 'eco',  nome:'Politiche economiche',        percentuale:0.0666, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',    percentuale:0.0532, link:'' },
  { id: 'def',  nome:'Difesa',                      percentuale:0.0437, link:'' },
  { id: 'cul',  nome:'Cultura e sport',             percentuale:0.0238, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico', percentuale:0.0210, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                 percentuale:0.0180, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',       percentuale:0.0159, link:'' },
  { id: 'giu',  nome:'Giustizia',                   percentuale:0.0113, link:'' },
  { id: 'alt',  nome:'Altro',                       percentuale:0.0398, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.00708, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00508, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00190, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00149, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00120, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00050, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00040, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00035, link:'/article/europe/sicurezza_difesa.php' },
];

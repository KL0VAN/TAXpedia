...
/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 16320, rate: 0.25 },
  { upper: 28800, rate: 0.40 },
  { upper: 49840, rate: 0.45 },
  { upper: Infinity, rate: 0.50 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.377, link:'' },
  { id: 'san',  nome:'Sanità',                           percentuale:0.148, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',             percentuale:0.117, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.071, link:'' },
  { id: 'eco',  nome:'Politiche economiche',             percentuale:0.067, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',       percentuale:0.052, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.041, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico',      percentuale:0.027, link:'' },
  { id: 'def',  nome:'Difesa',                           percentuale:0.024, link:'' },
  { id: 'cul',  nome:'Cultura e sport',                  percentuale:0.023, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',            percentuale:0.021, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.020, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.004, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.008, link:'' }
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0078, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0057, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0022, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.0017, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.0013, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.0006, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.0005, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.0002, link:'/article/europe/sicurezza_difesa.php' },
];

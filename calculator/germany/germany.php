...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Germania)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Germania)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Germania",
    ...
    'box_eu_desc' => "Distribuzione del contributo tedesco al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Germany)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Germany)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Germany allocation chart",
    ...
    'box_eu_desc' => "Allocation of Germany’s contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorGermany.js"></script>
</head>
<body>

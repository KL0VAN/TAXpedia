...
/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 12450, rate: 0.095 },
  { upper: 20200, rate: 0.120 },
  { upper: 35200, rate: 0.150 },
  { upper: 60000, rate: 0.185 },
  { upper: 300000, rate: 0.225 },
  { upper: Infinity, rate: 0.245 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.560, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.174, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.069, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.039, link:'' },
  { id: 'eco',  nome:'Politiche economiche',             percentuale:0.034, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',             percentuale:0.028, link:'' },
  { id: 'def',  nome:'Difesa',                           percentuale:0.027, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico',      percentuale:0.023, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',            percentuale:0.018, link:'' },
  { id: 'san',  nome:'Sanità',                           percentuale:0.012, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',       percentuale:0.007, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.005, link:'' },
  { id: 'cul',  nome:'Cultura e sport',                  percentuale:0.003, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.001, link:'' }
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0153, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0111, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0042, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.0033, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.0025, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.0012, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.0009, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.0005, link:'/article/europe/sicurezza_difesa.php' },
];

...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo spagnolo al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Spain)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Spain)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Spain allocation chart",
    ...
    'box_eu_desc' => "Allocation of Spain’s contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorSpain.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=SP"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Ministerio de Economía, Comercio y Empresa</li>
        <li>Secretaría de Estado de Presupuestos y Gastos/li>
      </ul>
      </section>
    </div>
  </main>

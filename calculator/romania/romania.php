...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo rumeno al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'box_eu_desc' => "Allocation of Romania's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorRomania.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=RO"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        ...
        <li>Legea bugetului de stat pe anul 2026</li>
        <li>Legea bugetului asigurărilor sociale de stat pe anul 2026</li>
        <li>Anexa 3 – Bugetele ordonatorilor principali de credite</li>
        <li>Raport privind situația macroeconomică pe anul 2026 și proiecția acesteia pe anii 2027-2029</li>
      </ul>
      </section>
    </div>
  </main>

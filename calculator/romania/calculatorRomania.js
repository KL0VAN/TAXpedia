...
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',          percentuale:0.3280, link:'' },
  { id: 'san',  nome:'Sanità',                      percentuale:0.1390, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',        percentuale:0.0840, link:'' },
  { id: 'eco',  nome:'Politiche economiche',        percentuale:0.0840, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',  percentuale:0.0780, link:'' },
  { id: 'int',  nome:'Interessi',                   percentuale:0.0760, link:'' },
  { id: 'def',  nome:'Difesa',                      percentuale:0.0640, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico', percentuale:0.0560, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',    percentuale:0.0280, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                 percentuale:0.0280, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',       percentuale:0.0100, link:'' },
  { id: 'giu',  nome:'Giustizia',                   percentuale:0.0090, link:'' },
  { id: 'cul',  nome:'Cultura e sport',             percentuale:0.0030, link:'' },
  { id: 'alt',  nome:'Altro',                       percentuale:0.0130, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.01101, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00791, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00295, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00232, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00187, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00077, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00063, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00054, link:'/article/europe/sicurezza_difesa.php' },
];

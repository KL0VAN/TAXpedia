...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Paesi Bassi)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Paesi Bassi)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Paesi Bassi",
    ...
    'box_eu_desc' => "Distribuzione del contributo olandese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Netherlands)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Netherlands)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Netherlands allocation chart",
    ...
    'box_eu_desc' => "Allocation of the Netherlands' contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorNetherlands.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=NL"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Directoraat-generaal Rijksbegroting</li>
        <li>Ministerie van Financiën</li>
      </ul>
      </section>
    </div>
  </main>

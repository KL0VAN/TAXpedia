...
/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 38441, rate: 0.3582 },
  { upper: 76817, rate: 0.3748 },
  { upper: Infinity, rate: 0.495 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'san',  nome:'Sanità',                           percentuale:0.242, link:'' },
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.238, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.135, link:'' },
  ...
  { id: 'inf',  nome:'Infrastrutture e trasporti',       percentuale:0.039, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico',      percentuale:0.024, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.023, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.018, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.014, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',            percentuale:0.011, link:'' },
  { id: 'cul',  nome:'Cultura e sport',                  percentuale:0.007, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.024, link:'' }
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0090, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0065, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0025, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.0019, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.0015, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.0007, link:'/article/europe/strumenti_speciali.php' },

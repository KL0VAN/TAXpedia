...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Portogallo)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Portogallo)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Portogallo",
    ...
    'box_eu_desc' => "Distribuzione del contributo portoghese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Portugal)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Portugal)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Portugal allocation chart",
    ...
    'box_eu_desc' => "Allocation of Portugal’s contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorPortugal.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=DE"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Orçamento do Estado 2024</li>
        <li>INE (Statistics Portugal)</li>
      </ul>
      </section>
    </div>
  </main>

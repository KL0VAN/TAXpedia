/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 72493,   rate: 0.15 },
  { upper: Infinity, rate: 0.23 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',          percentuale:0.4291, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',        percentuale:0.1267, link:'' },
  { id: 'def',  nome:'Difesa',                      percentuale:0.0735, link:'' },
  { id: 'eco',  nome:'Politiche economiche',        percentuale:0.0590, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',  percentuale:0.0520, link:'' },
  { id: 'int',  nome:'Interessi',                   percentuale:0.0453, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico', percentuale:0.0386, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',    percentuale:0.0303, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                 percentuale:0.0292, link:'' },
  { id: 'giu',  nome:'Giustizia',                   percentuale:0.0170, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',       percentuale:0.0095, link:'' },
  { id: 'cul',  nome:'Cultura e sport',             percentuale:0.0092, link:'' },
  { id: 'san',  nome:'Sanità',                      percentuale:0.0033, link:'' },
  { id: 'alt',  nome:'Altro',                       percentuale:0.0773, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.01384, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00994, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00371, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00292, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00235, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00097, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00079, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00068, link:'/article/europe/sicurezza_difesa.php' },
];

...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo ceco al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Czech)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Czech)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Czech allocation chart",
    ...
    'box_eu_desc' => "Allocation of Czech's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorCzech.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=CZ"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        ...
        <li>Zákon č. 38/2026 Sb., o státním rozpočtu České republiky na rok 2026</li>
      </ul>
      </section>
    </div>
  </main>

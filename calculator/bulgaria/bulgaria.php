...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Bulgaria)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Bulgaria)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Bulgaria",
    ...
    'box_eu_desc' => "Distribuzione del contributo bulgaro al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'box_eu_desc' => "Allocation of Bulgaria's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorBulgaria.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=BG"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Министерство на финансите</li>
        <li>Закон за държавния бюджет на Република България за 2025 г.</li>
        <li>Закон за бюджета на държавното обществено осигуряване за 2025 г.</li>
        <li>Закон за бюджета на Националната здравноосигурителна каса за 2025 г.</li>
        <li>Постановление № 28 от 16 април 2025 г. за изпълнението на държавния бюджет на Република България за 2025 г.</li>
      </ul>
      </section>
    </div>
  </main>

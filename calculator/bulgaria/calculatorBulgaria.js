/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 25339, rate: 0.08622 },
  { upper: Infinity, rate: 0.10 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',          percentuale:0.4567, link:'' },
  { id: 'san',  nome:'Sanità',                      percentuale:0.1578, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico', percentuale:0.0699, link:'' },
  { id: 'def',  nome:'Difesa',                      percentuale:0.0643, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',  percentuale:0.0472, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',        percentuale:0.0412, link:'' },
  { id: 'giu',  nome:'Giustizia',                   percentuale:0.0312, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                 percentuale:0.0299, link:'' },
  { id: 'int',  nome:'Interessi',                   percentuale:0.0232, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',    percentuale:0.0230, link:'' },
  { id: 'eco',  nome:'Politiche economiche',        percentuale:0.0179, link:'' },
  { id: 'cul',  nome:'Cultura e sport',             percentuale:0.0094, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',       percentuale:0.0022, link:'' },
  { id: 'alt',  nome:'Altro',                       percentuale:0.0261, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.01176, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00844, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00316, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00248, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00199, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00083, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00066, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00058, link:'/article/europe/sicurezza_difesa.php' },
];

...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Danimarca)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Danimarca)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Danimarca",
    ...
    'box_eu_desc' => "Distribuzione del contributo danese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Denmark)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Denmark)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Denmark allocation chart",
    ...
    'box_eu_desc' => "Allocation of Denmark's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorDenmark.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=DK"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>

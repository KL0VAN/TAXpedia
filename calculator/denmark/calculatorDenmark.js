/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 76123,  rate: 0.121 },
  { upper: Infinity, rate: 0.15 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.356, link:'' },
  { id: 'san',  nome:'Sanità',                           percentuale:0.142, link:'' },
  { id: 'def',  nome:'Difesa',                           percentuale:0.085, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',             percentuale:0.072, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.046, link:'' },
  { id: 'eco',  nome:'Politiche economiche',             percentuale:0.036, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',       percentuale:0.030, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.025, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico',      percentuale:0.019, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',            percentuale:0.018, link:'' },
  { id: 'cul',  nome:'Cultura e sport',                  percentuale:0.016, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.012, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.009, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.134, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.00986, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00708, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00264, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00208, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00167, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00069, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00056, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00042, link:'/article/europe/sicurezza_difesa.php' },
];

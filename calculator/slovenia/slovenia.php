...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'legend_it_aria' => "Dettaglio (Slovenia)",
    'legend_title' => "Settore — Importo ",
    'legend_subtle_it' => "(Slovenia)",
    'legend_note' => "Clicca per aprire il dettaglio. Hover per evidenziare la fetta.",
    'chart_it_aria' => "Grafico ripartizione Slovenia",
    ...
    'box_eu_desc' => "Distribuzione del contributo sloveno al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'box_eu_desc' => "Allocation of Slovenia’s contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorSlovenia.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <ul>
        <li>Zaključni račun proračuna 2024</li>
        <li>SURS (Statistical Office of Slovenia)</li>
      </ul>
      </section>
    </div>
  </main>

...
/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 9721.43,  rate: 0.16 },
  { upper: 28592.44, rate: 0.26 },
  { upper: 57184.88, rate: 0.33 },
  { upper: 82346.23, rate: 0.39 },
...
const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0079, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0057, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0021, link:'/article/europe/mercato_unico.php' },

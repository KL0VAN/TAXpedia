...
const SETTORI = [
  { id: 'eco',  nome:'Politiche economiche',             percentuale:0.290, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',             percentuale:0.175, link:'' },
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.096, link:'' },
  { id: 'def',  nome:'Difesa',                           percentuale:0.088, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.082, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.074, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico',      percentuale:0.037, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.034, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',            percentuale:0.029, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.019, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',       percentuale:0.015, link:'' },
  { id: 'cul',  nome:'Cultura e sport',                  percentuale:0.012, link:'' },
  { id: 'san',  nome:'Sanità',                           percentuale:0.002, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.047, link:'' }
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0133, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0096, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0037, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.0029, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.0022, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.0011, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.0008, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.0004, link:'/article/europe/sicurezza_difesa.php' },
];

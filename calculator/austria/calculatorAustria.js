...
/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 13308,   rate: 0.00 },
  { upper: 21617,   rate: 0.20 },
  { upper: 35836,   rate: 0.30 },
  { upper: 69166,   rate: 0.40 },
  { upper: 103072,  rate: 0.48 },
  { upper: 1000000, rate: 0.50 },
  { upper: Infinity, rate: 0.55 }, // fino al 2025
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.459, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',             percentuale:0.159, link:'' },  
  { id: 'eco',  nome:'Politiche economiche',             percentuale:0.076, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.066, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',       percentuale:0.048, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico',      percentuale:0.038, link:'' },
  { id: 'def',  nome:'Difesa',                           percentuale:0.035, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.025, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.025, link:'' },
  { id: 'san',  nome:'Sanità',                           percentuale:0.022, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.019, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',            percentuale:0.017, link:'' },
  { id: 'cul',  nome:'Cultura e sport',                  percentuale:0.009, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.002, link:'' }
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0098, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0071, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0027, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.0021, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.0016, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.0008, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.0006, link:'/article/europe/migrazione_gestione.php' },
...
function calcolaIRPEF(reddito) {
  // Austria — progressive income tax (uses TAX_BRACKETS defined above)
  // (mantengo il nome per non toccare il resto del codice)
  let imposta = 0;
  let prev = 0;

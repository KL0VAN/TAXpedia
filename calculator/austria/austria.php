...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo austriaco al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'box_eu_desc' => "Allocation of Austria’s contribution to the European Union budget.",
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=AT"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Bundesministerium für Finanzen</li>
        <li>Bundesvoranschlag 2025</li>
      </ul>
      </section>
    </div>
  </main>

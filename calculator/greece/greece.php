...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo svedese al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Greece)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Greece)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Greece allocation chart",
    ...
    'box_eu_desc' => "Allocation of Greece's contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorGreece.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=GR"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Υπουργείο Εθνικής Οικονομίας και Οικονομικών</li>
        <li>Κρατικός Προϋπολογισμός 2026</li>
        <li>Εισηγητική Έκθεση Προϋπολογισμού 2026</li>
        <li>Προϋπολογισμός Επιδόσεων 2026</li>
        <li>Φορολογικός Οδηγός</li>
        <li>Φορολογία Εισοδήματος</li>
        <li>Φόρος Προστιθέμενης Αξίας (Φ.Π.Α.)</li>
        <li>Δελτία Εκτέλεσης Προϋπολογισμού</li>
      </ul>
      </section>
    </div>
  </main>

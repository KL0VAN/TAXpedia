/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 10000, rate: 0.09 },
  { upper: 20000, rate: 0.20 },
  { upper: 30000, rate: 0.26 },
  { upper: 40000, rate: 0.34 },
  { upper: 60000, rate: 0.39 },
  { upper: Infinity, rate: 0.44 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',          percentuale:0.3676, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',    percentuale:0.1269, link:'' },
  { id: 'san',  nome:'Sanità',                      percentuale:0.1152, link:'' },
  { id: 'eco',  nome:'Politiche economiche',        percentuale:0.0853, link:'' },
  { id: 'edu',  nome:'Istruzione e ricerca',        percentuale:0.0670, link:'' },
  { id: 'int',  nome:'Interessi',                   percentuale:0.0599, link:'' },
  { id: 'def',  nome:'Difesa',                      percentuale:0.0466, link:'' },
  { id: 'inf',  nome:'Infrastrutture e trasporti',  percentuale:0.0382, link:'' },
  { id: 'sic',  nome:'Sicurezza e ordine pubblico', percentuale:0.0343, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                 percentuale:0.0234, link:'' },
  { id: 'cul',  nome:'Cultura e sport',             percentuale:0.0144, link:'' },
  { id: 'amb',  nome:'Protezione ambientale',       percentuale:0.0138, link:'' },
  { id: 'giu',  nome:'Giustizia',                   percentuale:0.0074, link:'' },
  { id: 'alt',  nome:'Altro',                       percentuale:0.0000, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.00921, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.00661, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.00247, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.00194, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.00156, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.00064, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.00052, link:'/article/europe/migrazione_gestione.php' },
  { nome:'Sicurezza e Difesa',                           percentuale:0.00045, link:'/article/europe/sicurezza_difesa.php' },
];

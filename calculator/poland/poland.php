...
$ITLP_I18N = array(
  ...
  'it' => array(
    ...
    'box_eu_desc' => "Distribuzione del contributo polacco al bilancio dell'Unione Europea.",
  ...
  'en' => array(
    ...
    'legend_it_aria' => "Breakdown (Poland)",
    'legend_title' => "Sector — Amount ",
    'legend_subtle_it' => "(Poland)",
    'legend_note' => "Click to open details. Hover to highlight the slice.",
    'chart_it_aria' => "Poland allocation chart",
    ...
    'box_eu_desc' => "Allocation of Poland’s contribution to the European Union budget.",
...
<head>
  ...
  <script defer src="calculatorPoland.js"></script>
</head>
<body>
  ...
  <main class="container" id="main">
    ...
    <div id="risultati" class="results" hidden aria-live="polite" aria-atomic="true">
      ...
      <div class="cta-row" style="text-align: center;">
        <a class="btn btn-primary" href="/tools/comparison.php?a=PL"><?php echo itlp_e('comparison_btn'); ?></a>
      </div><br>
      ...
      <ul>
        <li>Planowanie w układzie zadaniowym na 2024 rok</li>
      </ul>
      </section>
    </div>
  </main>

...
/* ========================= CONFIG ========================= */
const TAX_BRACKETS = [
  { upper: 28077, rate: 0.12 },
  { upper: 233978, rate: 0.32 },
  { upper: Infinity, rate: 0.36 },
];

// Percorsi ai file di testo - aggiornare i nomi/file se necessario
const SETTORI = [
  { id: 'welf', nome:'Protezione sociale',               percentuale:0.462, link:'' },
  { id: 'pa',   nome:'Pubblica amministrazione',         percentuale:0.142, link:'' },
  { id: 'edu',  nome:'Istruzione e Ricerca',             percentuale:0.095, link:'' },
  { id: 'def',  nome:'Difesa',                           percentuale:0.074, link:'' },
  { id: 'int',  nome:'Interessi',                        percentuale:0.057, link:'' },
  { id: 'eco',  nome:'Politiche economiche',             percentuale:0.046, link:'' },
  { id: 'san',  nome:'Sanità',                           percentuale:0.024, link:'' },
  { id: 'inf',  nome:'Infrastrutture e Trasporti',       percentuale:0.023, link:'' },
  { id: 'sic',  nome:'Sicurezza e Ordine pubblico',      percentuale:0.022, link:'' },
  { id: 'giu',  nome:'Giustizia',                        percentuale:0.019, link:'' },
  { id: 'ue',   nome:'Bilancio UE',                      percentuale:0.014, link:'' },
  { id: 'amb',  nome:'Protezione Ambientale',            percentuale:0.012, link:'' },
  { id: 'cul',  nome:'Cultura e Sport',                  percentuale:0.008, link:'' },
  { id: 'alt',  nome:'Altro',                            percentuale:0.002, link:'' },
];

const SETTORI_UE = [
  { nome:'Coesione, resilienza e valori',                percentuale:0.0055, link:'/article/europe/coesione.php' },
  { nome:'Risorse naturali e ambiente',                  percentuale:0.0040, link:'/article/europe/risorse_naturali.php' },
  { nome:'Mercato unico, innovazione e agenda digitale', percentuale:0.0015, link:'/article/europe/mercato_unico.php' },
  { nome:'Rapporti con il vicinato e con il mondo',      percentuale:0.0012, link:'/article/europe/rapporti_vicinato.php' },
  { nome:'Pubblica amministrazione europea',             percentuale:0.0009, link:'/article/europe/pubblica_amm_ue.php' },
  { nome:'Strumenti speciali',                           percentuale:0.0004, link:'/article/europe/strumenti_speciali.php' },
  { nome:'Migrazione e gestione delle frontiere',        percentuale:0.0003, link:'/article/europe/migrazione_gestione.php' },

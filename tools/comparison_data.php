...
return [
  ...
  'countries' => [
    ...
    'BG' => [
      'name_it' => 'Bulgaria',
      'name_en' => 'Bulgaria',
      'flag_path' => '/calculator/bulgaria/flagbulgaria.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 15972,
        'debt_gdp' => null,
        'politiche_economiche' => 1.8,
        'protezione_sociale' => 45.7,
        'pubblica_amministrazione' => 2.3,
        'sanita' => 15.8,
        'interessi' => 2.3,
        'istruzione_ricerca' => 4.1,
        'difesa' => 6.4,
        'bilancio_ue' => 3.0,
        'infrastrutture' => 4.7,
        'sicurezza' => 7.0,
        'protezione_ambientale' => 0.2,
        'giustizia' => 3.1,
        'cultura' => 0.9,
        'altro' => 2.6,
      ],
    ...
    'CZ' => [
      'name_it' => 'Cechia',
      'name_en' => 'Czechia',
      'flag_path' => '/calculator/czech/flagczech.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 24286,
        'debt_gdp' => null,
        'politiche_economiche' => 5.9,
        'protezione_sociale' => 42.9,
        'pubblica_amministrazione' => 3.0,
        'sanita' => 0.3,
        'interessi' => 4.5,
        'istruzione_ricerca' => 12.7,
        'difesa' => 7.4,
        'bilancio_ue' => 2.9,
        'infrastrutture' => 5.2,
        'sicurezza' => 3.9,
        'protezione_ambientale' => 1.0,
        'giustizia' => 1.7,
        'cultura' => 0.9,
        'altro' => 7.7,
      ],
    ...
    'DK' => [
      'name_it' => 'Danimarca',
      'name_en' => 'Denmark',
      'flag_path' => '/calculator/denmark/flagdenmark.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 75000,
        'debt_gdp' => null,
        'politiche_economiche' => 3.6,
        'protezione_sociale' => 35.6,
        'pubblica_amministrazione' => 4.6,
        'sanita' => 14.2,
        'interessi' => 1.2,
        'istruzione_ricerca' => 7.2,
        'difesa' => 8.5,
        'bilancio_ue' => 2.5,
        'infrastrutture' => 3.0,
        'sicurezza' => 1.9,
    ...
    'GR' => [
      'name_it' => 'Grecia',
      'name_en' => 'Greece',
      'flag_path' => '/calculator/greece/flaggreece.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 18000,
        'debt_gdp' => null,
        'politiche_economiche' => 8.5,
        'protezione_sociale' => 36.8,
        'pubblica_amministrazione' => 12.7,
        'sanita' => 11.5,
        'interessi' => 6.0,
        'istruzione_ricerca' => 6.7,
        'difesa' => 4.7,
        'bilancio_ue' => 2.3,
        'infrastrutture' => 3.8,
        'sicurezza' => 3.4,
        'protezione_ambientale' => 1.4,
        'giustizia' => 0.7,
        'cultura' => 1.4,
        'altro' => 0.0,
      ],
    ...
    'HU' => [
      'name_it' => 'Ungheria',
      'name_en' => 'Hungary',
      'flag_path' => '/calculator/hungary/flaghungary.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 23146,
        'debt_gdp' => null,
        'politiche_economiche' => 6.7,
        'protezione_sociale' => 30.1,
        'pubblica_amministrazione' => 5.3,
        'sanita' => 16.3,
        'interessi' => 7.7,
        'istruzione_ricerca' => 9.6,
        'difesa' => 4.4,
        'bilancio_ue' => 1.8,
        'infrastrutture' => 7.0,
        'sicurezza' => 2.1,
    ...
    'IE' => [
      'name_it' => 'Irlanda',
      'name_en' => 'Ireland',
      'flag_path' => '/calculator/ireland/flagireland.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 52618,
        'debt_gdp' => null,
        'politiche_economiche' => 3.9,
        'protezione_sociale' => 27.0,
        'pubblica_amministrazione' => 2.5,
        'sanita' => 20.5,
        'interessi' => 2.3,
        'istruzione_ricerca' => 13.5,
        'difesa' => 1.1,
        'bilancio_ue' => 3.3,
        'infrastrutture' => 8.9,
        'sicurezza' => 2.4,
        'protezione_ambientale' => 2.3,
        'giustizia' => 2.4,
        'cultura' => 1.5,
        'altro' => 8.4,
      ],
    ...
    'RO' => [
      'name_it' => 'Romania',
      'name_en' => 'Romania',
      'flag_path' => '/calculator/romania/flagromania.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 21701,
        'debt_gdp' => null,
        'politiche_economiche' => 8.4,
        'protezione_sociale' => 32.8,
        'pubblica_amministrazione' => 2.8,
        'sanita' => 13.9,
        'interessi' => 7.6,
        'istruzione_ricerca' => 8.4,
        'difesa' => 6.4,
        'bilancio_ue' => 2.8,
        'infrastrutture' => 7.8,
        'sicurezza' => 5.6,
    ...
    'SE' => [
      'name_it' => 'Svezia',
      'name_en' => 'Sweden',
      'flag_path' => '/calculator/sweden/flagsweden.png',
      'metrics' => [
        'valuta' => 'EUR',
        'reddito_medio' => 46439,
        'debt_gdp' => null,
        'politiche_economiche' => 4.7,
        'protezione_sociale' => 32.1,
        'pubblica_amministrazione' => 4.1,
        'sanita' => 8.6,
        'interessi' => 2.0,
        'istruzione_ricerca' => 13.0,
        'difesa' => 11.8,
        'bilancio_ue' => 3.3,
        'infrastrutture' => 7.5,
        'sicurezza' => 3.4,
